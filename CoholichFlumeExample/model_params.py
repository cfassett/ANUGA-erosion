...
# DOMAIN PARAMETERS
gravity=9.8        # Mars Gravity       m/s2                  
dthresh=0.001       # Depth Threshold    m  {Anuga numerical  parameter}

# FRICTION SCHEME
frictionscheme="constant"   # "wilsonetal", "larsenandlamb", "constant"   -->defaults to constant
constantn=0.032          # Used for constant, default in unwet cells for other schemes
...
angleofrepose=45.0  # Degrees

# FLUID/SEDIMENT PARAMETERS
grainD=0.0005       # Grain Size         m   MAIN PARAMETER FOR CONTROLLING RESISTANCE
                   #                        TO FLOW

Wd=1000.0          # Water Density      kg/m3
Sd=1660.0          # Sediment Density   kg/m3 
